...
begin
  try
    Acesso := TAcesso.Create(Text, NumeroID, 'N');
    if Assigned(Parent) then
      Result := treeView.Items.AddChildObject(Parent, Text, Acesso)
    else
    begin
...
{ DIREITOS DE ACESSO }
procedure TfrmMain.ListartreeView;
var
  { DECLARAÇÃO DOS NÓS }
...
begin
  ...
  try
    ...
    CriarTreeViewItem(NoClienteFornecedor, 'Configurações: Tabela de Preço',
      '03.01.02.11');
    CriarTreeViewItem(NoClienteFornecedor, 'Tabela de Descontos',
      '03.01.02.12');
    ...
    NoSaidas := CriarTreeViewItem(NoMovimentos,
      'Saídas de Mercadorias', '04.03');
    ...
    CriarTreeViewItem(NoConsultar, 'Expandir Acerto de Clientes',
      '04.03.04.03');
    ...
    // Controle de Boletos
    NoBoletos := CriarTreeViewItem(NoFinanceiro, 'Controle de Boletos',
      '05.04');
    ...
    CriarTreeViewItem(NoConciCartoes, 'Alterar Adquirente/Bandeira',
      '05.09.04');
    ...
    NoCashback := CriarTreeViewItem(NoFinanceiro,
      'Controle de Cashback', '05.12');
    ...
    NoMoviCombustivel := CriarTreeViewItem(NoCombustivel, 'Movimentos',
      '07.05.01');
    CriarTreeViewItem(NoMoviCombustivel, 'Lançamento sobre Rodas',
      '07.05.01.01');
    CriarTreeViewItem(NoMoviCombustivel, 'Lançamento Descargas', '07.05.01.02');
    CriarTreeViewItem(NoMoviCombustivel, 'Consultar Lançamentos',
      '07.05.01.03');
