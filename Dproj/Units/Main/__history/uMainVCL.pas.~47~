...
uses
  ...
  FireDAC.Comp.Client, uBase, Vcl.StdCtrls;
...
type
  ...
  private
  function CriarTreeViewItem(Parent: TTreeNode; const Text, NumeroID: String): TTreeNode;
...
function TfrmMain.CriarTreeViewItem(Parent: TTreeNode; const Text, NumeroID:
String): TTreeNode;
var
  Acesso: TAcesso;
begin
...
procedure TfrmMain.treeViewCheckStateChanged(Sender: TCustomTreeView; Node: TTreeNode;
  CheckState: TNodeCheckState);  
begin
  inherited;
